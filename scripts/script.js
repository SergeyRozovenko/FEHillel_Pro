...
const student1 =  prompt("Введите возраст первого студента") + ' років' +
                  prompt("Введите имя первого студента")  + ' ' +
                  prompt("Введите фамилию первого студента");
                   
const student2 =  prompt("Введите возраст второго студента") + ' років' + 
                  prompt("Введите имя второго студента")  + ' ' +
                  prompt("Введите фамилию второго студента");

const student3 =  prompt("Введите возраст третьего студента") + ' років'  +
